...
public class Cancelacion {
    ...
    private SOAPMessage peticionCancelacion() throws Exception {
        ...
        for (folio f : this.folios) {
            ...
            SOAPElement motivoElement = folioElement.addChildElement("motivo");
            motivoElement.addTextNode(f.getMotivo());
            motivoElement.setAttribute("xsi:type", "xsd:string");
            
            SOAPElement foliosustitutoElement = folioElement.addChildElement("folio_sustituto");
            foliosustitutoElement.addTextNode(f.getFolio_sustituto());
            foliosustitutoElement.setAttribute("xsi:type", "xsd:string");
        }
